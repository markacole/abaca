//
//  ABCInfoViewController-iPhone.m
//  abaca
//
...
@implementation ABCInfoViewController_iPhone
...
- (IBAction)rateButtonPressed:(id)sender {
    [super rateButtonPressed:sender];
}

- (IBAction)emailButtonPressed:(id)sender {
    [super emailButtonPressed:sender];
}

- (IBAction)webButtonPressed:(id)sender {
    [super webButtonPressed:sender];
}
